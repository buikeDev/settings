...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm px-[20px] py-[15px] text-[12px] text-[#90989F] outline-none focus:bg-[#E6F0FB] focus:text-black data-[disabled]:pointer-events-none data-[disabled]:opacity-50 rounded-[12px] justify-start",
      className
    )}
    {...props}
  >
